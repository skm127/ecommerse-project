  ...
  return (
    <div className="bg-primary min-h-screen">
      ...
      <section id="products" className="container mx-auto px-6 py-24">
        {/* Category Filter */}
        <div className="flex flex-wrap items-center gap-8 mb-16 border-b border-white/5 pb-4">
          {categories.map((cat) => (
            <button
              key={cat}
              onClick={() => setCategory(cat)}
              className={`text-sm tracking-wide pb-4 relative transition-colors ${
                category === cat
                  ? 'text-white'
      ...
      <section className="border-t border-white/5 py-24">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
          {[
            { title: 'Complimentary Shipping', desc: 'On all orders above $100.' },
